@testset "Linear systems" begin
    @testset "LinearUnivariateTimeInvariant" begin
        ...
        system = StateSpaceModels.LinearUnivariateTimeInvariant{Float64}(y, Z, T, R, d, c, H, Q)
        ...
        sim, alpha = StateSpaceModels.simulate(system, initial_state, n_obs_sim; return_simulated_states = true)
