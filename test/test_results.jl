...
@testset "Air passengers with Kalman filter" begin
    ...
    @test ss3.smoother.alpha ≈ ss1.smoother.alpha rtol = 1e-2 # !!! univariate failing
    @test ss2.filter.a ≈ ss1.filter.a rtol = 1e-2
    @test ss3.filter.a ≈ ss1.filter.a rtol = 1e-2
end